...
const IPhone13ProMax240 = () => {
  return (
    <View style={styles.iphone13ProMax240}>
      <View
        style={[styles.iphone13ProMax240Child, styles.searchScreenPosition]}
      />
      <View style={styles.iphone13ProMax240Item} />
      ...
      <Image
        style={styles.iphone13ProMax240Inner}
        contentFit="cover"
...
export default IPhone13ProMax240;
