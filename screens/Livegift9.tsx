        ...
        >
          <View style={styles.frameLayout}>
            <Pressable
              ...
              onPress={() => navigation.navigate("Livegift3")}
            >
              <Image
            ...
            <Pressable
              ...
              onPress={() => navigation.navigate("Livegift4")}
            >
              <Image
                style={styles.ringCase1}
                contentFit="cover"
            ...
            <Pressable
              ...
              onPress={() => navigation.navigate("Livegift5")}
            >
              <Image
                style={styles.ringCase1}
                contentFit="cover"
          ...
          <View style={[styles.frameContainer, styles.frameLayout]}>
            <Pressable
              style={[styles.ringCase1Parent, styles.parentPosition]}
              onPress={() => navigation.navigate("Livegift6")}
            >
              <Image
                style={styles.ringCase1}
                contentFit="cover"
            ...
            <Pressable
              style={[styles.sun1Parent, styles.parentPosition]}
              onPress={() => navigation.navigate("Livegift7")}
            >
              <Image
                style={styles.ringCase1}
                contentFit="cover"
            ...
            <Pressable
              style={[styles.mg1Parent, styles.parentPosition]}
              onPress={() => navigation.navigate("Livegift8")}
            >
              <Image
                style={styles.ringCase1}
                contentFit="cover"
