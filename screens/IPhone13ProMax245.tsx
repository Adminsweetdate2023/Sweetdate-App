...
const IPhone13ProMax245 = () => {
  return (
    <View style={styles.iphone13ProMax245}>
      <View
        style={[styles.iphone13ProMax245Child, styles.searchScreenPosition]}
      />
      <View style={styles.iphone13ProMax245Item} />
      ...
      <Image
        style={styles.iphone13ProMax245Inner}
        contentFit="cover"
...
export default IPhone13ProMax245;
