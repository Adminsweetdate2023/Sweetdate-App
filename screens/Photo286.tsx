  ...
  return (
    <View style={styles.photo2}>
      <Pressable
        ...
        onPress={() => navigation.navigate("Connect22")}
      >
        <Image
          style={[styles.groupChild, styles.groupChildPosition]}
          contentFit="cover"
          source={require("../assets/rectangle-602.png")}
        />
        <View style={[styles.ellipseParent, styles.groupLayout]}>
          <Image
            style={[styles.groupItem, styles.groupLayout]}
            contentFit="cover"
            source={require("../assets/ellipse-2910.png")}
          />
      ...
      >
        ...
        <View style={[styles.ellipseGroup, styles.groupPosition]}>
          <Image
            ...
            contentFit="cover"
            source={require("../assets/ellipse-2911.png")}
          />
      ...
      >
        <Image
          style={[styles.groupChild, styles.groupChildPosition]}
          contentFit="cover"
          source={require("../assets/rectangle-613.png")}
        />
        <View style={[styles.groupView, styles.groupViewPosition]}>
          <Image
            style={[styles.ellipseIcon, styles.groupLayout]}
            contentFit="cover"
            source={require("../assets/ellipse-2913.png")}
          />
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Photo245")}
      >
      ...
      <View style={[styles.rectangleParent1, styles.rectangleLayout]}>
        ...
        <View style={[styles.newWrapper, styles.wrapperPosition]}>
          <Pressable
            style={[styles.new, styles.allPosition]}
            onPress={() => navigation.navigate("Photo285")}
          >
            <Text style={[styles.new1, styles.allTypo]}>New</Text>
          </Pressable>
        </View>
