  ...
  return (
    <View style={styles.photo2}>
      <View style={styles.statusBar}>
        <View
          style={[styles.iphoneXStatusBarLightBack, styles.borderPosition]}
        />
        <View style={styles.battery}>
          <View style={[styles.border, styles.borderBg]} />
          <Image
            style={[styles.capIcon, styles.iconLayout]}
            contentFit="cover"
            source={require("../assets/cap.png")}
          />
          <View style={[styles.capacity, styles.borderBg]} />
        </View>
        <Image
        ...
        />
        <Text style={styles.text}>4:21</Text>
      </View>
      <View style={styles.rectangleParent}>
        ...
        <View style={[styles.parent, styles.parentLayout]}>
          <Text style={[styles.text1, styles.textFlexBox1]}>0</Text>
          <Image
      ...
      <View style={styles.rectangleGroup}>
        ...
        />
        <Text style={styles.shareEarn}>{`SHARE & EARN 110 COINS`}</Text>
        ...
        <View style={styles.groupParent}>
          <View style={styles.groupLayout}>
            <View style={[styles.rectangleContainer, styles.rectangleLayout]}>
              ...
              <View style={[styles.groupView, styles.groupParentLayout]}>
                ...
                <Text style={[styles.text2, styles.textTypo2]}>$70</Text>
              </View>
              <Text style={[styles.text3, styles.textTypo1]}>150</Text>
              <Image
            ...
            <View style={[styles.groupParent1, styles.rectangleLayout]}>
              ...
              <Text style={[styles.text3, styles.textTypo1]}>300</Text>
              <View style={styles.icons8Gift941Parent}>
                ...
                <Image
                  ...
                  contentFit="cover"
                  source={require("../assets/icons8coins94-4.png")}
                />
                <Image
                ...
                <Image
                  ...
                  contentFit="cover"
                  source={require("../assets/icons8coins64-1.png")}
                />
                <Image
                  style={[styles.icons8Coins642, styles.icons8Layout]}
                  contentFit="cover"
                  source={require("../assets/icons8coins64-2.png")}
                />
                <Image
                  style={[styles.icons8Coins643, styles.icons8Layout]}
                  contentFit="cover"
                  source={require("../assets/icons8coins64-3.png")}
                />
              </View>
          ...
          <View style={[styles.groupParent2, styles.groupLayout]}>
            <View style={[styles.groupParent1, styles.rectangleLayout]}>
              ...
              <View style={[styles.rectangleParent4, styles.groupParentLayout]}>
                <View style={[styles.groupChild1, styles.groupChildPosition]} />
                <Text style={[styles.text6, styles.textTypo2]}>$150</Text>
              </View>
              <Text style={[styles.text3, styles.textTypo1]}>650</Text>
            ...
            <View style={[styles.rectangleContainer, styles.rectangleLayout]}>
              ...
              <View style={[styles.rectangleParent4, styles.groupParentLayout]}>
                <View style={[styles.groupChild1, styles.groupChildPosition]} />
                <Text style={[styles.text6, styles.textTypo2]}>$300</Text>
              </View>
              <Text style={[styles.text9, styles.textFlexBox]}>1200</Text>
          ...
          <View style={[styles.groupParent2, styles.groupLayout]}>
            <View style={[styles.groupParent1, styles.rectangleLayout]}>
              ...
              <View style={[styles.rectangleParent8, styles.groupParentLayout]}>
                <View style={[styles.groupChild1, styles.groupChildPosition]} />
                <Text style={[styles.text6, styles.textTypo2]}>$550</Text>
              </View>
              <Text style={[styles.text11, styles.textTypo]}>1700</Text>
            ...
            <View style={[styles.rectangleContainer, styles.rectangleLayout]}>
              ...
              <Image
                ...
                contentFit="cover"
                source={require("../assets/icons8coin64-1.png")}
              />
              <View style={[styles.rectangleParent8, styles.groupParentLayout]}>
                <View style={[styles.groupChild1, styles.groupChildPosition]} />
                <Text style={[styles.text6, styles.textTypo2]}>$700</Text>
              </View>
              <Text style={[styles.text11, styles.textTypo]}>2250</Text>
          ...
          <View style={[styles.rectangleParent11, styles.groupChild13Layout]}>
            ...
            <View style={[styles.rectangleParent12, styles.groupChild14Layout]}>
              ...
              <Text style={[styles.text14, styles.textTypo2]}>$1050</Text>
            </View>
            <Text style={[styles.text15, styles.textTypo]}>11000</Text>
