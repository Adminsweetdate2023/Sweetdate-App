    ...
    <View style={styles.photo2}>
      ...
      <View style={[styles.rectangleParent, styles.groupChildLayout]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo228")}
        >
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo229")}
        >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Moment120")}
      >
        <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Photo230")}
      >
        <Image
