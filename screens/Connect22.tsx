...
const Connect22 = () => {
  ...
  return (
    <Pressable
      style={styles.connect2}
      onPress={() => navigation.navigate("IPhone13ProMax234")}
    >
      <View style={[styles.connect2Inner, styles.groupChildPosition]}>
        <Image
          style={[styles.groupChild, styles.groupChildPosition]}
          contentFit="cover"
          source={require("../assets/rectangle-504.png")}
        />
      </View>
      <View
        style={[
      ...
      >
        <Image
          ...
          contentFit="cover"
          source={require("../assets/fluenthourglasshalf24regular1.png")}
        />
