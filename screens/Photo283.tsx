    ...
    <View style={styles.photo2}>
      <View style={[styles.rectangleParent, styles.groupChildPosition2]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Moment123")}
        >
          <Image
        ...
        <View style={[styles.rectangleContainer, styles.rectanglePosition]}>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo246")}
          >
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo247")}
          >
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo248")}
          >
        ...
        >
          <Pressable
            ...
            onPress={() => navigation.navigate("Moment125")}
          >
            <Image
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo250")}
        >
          <Image
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo255")}
        >
