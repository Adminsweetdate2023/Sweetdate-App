...
const IPhone13ProMax243 = () => {
  return (
    <View style={styles.iphone13ProMax243}>
      <View
        style={[styles.iphone13ProMax243Child, styles.searchScreenPosition]}
      />
      <View style={styles.iphone13ProMax243Item} />
      ...
      <Image
        style={styles.iphone13ProMax243Inner}
        contentFit="cover"
...
export default IPhone13ProMax243;
