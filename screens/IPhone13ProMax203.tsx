...
const IPhone13ProMax203 = () => {
  return (
    <View style={styles.iphone13ProMax203}>
      <View style={[styles.iphone13ProMax203Child, styles.groupItemPosition]} />
      <View style={[styles.iphone13ProMax203Item, styles.rectangleViewBg]} />
...
export default IPhone13ProMax203;
