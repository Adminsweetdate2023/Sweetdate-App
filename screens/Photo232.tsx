    ...
    <View style={styles.photo2}>
      <View style={[styles.rectangleParent, styles.groupChildPosition2]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Moment119")}
        >
          <Image
        ...
        <View style={[styles.rectangleContainer, styles.rectanglePosition]}>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo222")}
          >
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo223")}
          >
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo224")}
          >
        ...
        >
          <Pressable
            ...
            onPress={() => navigation.navigate("Moment121")}
          >
            <Image
        ...
        <Pressable
          style={styles.vector}
          onPress={() => navigation.navigate("Live11")}
        >
          <Image
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo226")}
        >
          <Image
