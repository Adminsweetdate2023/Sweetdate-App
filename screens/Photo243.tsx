    ...
    <View style={styles.photo2}>
      ...
      <View style={[styles.rectangleParent, styles.groupChildLayout]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo239")}
        >
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo240")}
        >
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo241")}
        >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Moment128")}
      >
        <Image
      ...
      >
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Moment129")}
        >
          <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Photo242")}
      >
        <Image
