...
const IPhone13ProMax199 = () => {
  return (
    <View style={styles.iphone13ProMax199}>
      <View style={[styles.iphone13ProMax199Child, styles.groupItemPosition]} />
      <View style={[styles.iphone13ProMax199Item, styles.rectangleViewBg]} />
      ...
      <View style={styles.iphone13ProMax199Inner}>
...
export default IPhone13ProMax199;
