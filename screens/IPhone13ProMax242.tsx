...
const IPhone13ProMax242 = () => {
  return (
    <View style={styles.iphone13ProMax242}>
      <View
        style={[styles.iphone13ProMax242Child, styles.searchScreenPosition]}
      />
      <View style={styles.iphone13ProMax242Item} />
      ...
      <Image
        style={styles.iphone13ProMax242Inner}
        contentFit="cover"
...
export default IPhone13ProMax242;
