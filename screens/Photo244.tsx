    ...
    <View style={styles.photo2}>
      <View style={[styles.rectangleParent, styles.groupChildPosition2]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Moment127")}
        >
          <Image
        ...
        <View style={[styles.rectangleContainer, styles.rectanglePosition]}>
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo234")}
          >
          ...
          <Pressable
            ...
            onPress={() => navigation.navigate("Photo236")}
          >
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo238")}
        >
          <Image
