...
const IPhone13ProMax201 = () => {
  return (
    <View style={styles.iphone13ProMax201}>
      <View style={[styles.iphone13ProMax201Child, styles.groupItemPosition]} />
      <View style={[styles.iphone13ProMax201Item, styles.rectangleViewBg]} />
...
export default IPhone13ProMax201;
