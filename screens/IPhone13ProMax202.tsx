...
const IPhone13ProMax202 = () => {
  return (
    <View style={styles.iphone13ProMax202}>
      <View style={[styles.iphone13ProMax202Child, styles.groupItemPosition]} />
      <View style={[styles.iphone13ProMax202Item, styles.rectangleViewBg]} />
...
export default IPhone13ProMax202;
