    ...
    <View style={styles.photo2}>
      ...
      <View style={[styles.rectangleParent, styles.groupChildLayout]}>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo251")}
        >
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo252")}
        >
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Photo253")}
        >
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Moment124")}
      >
        <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Photo254")}
      >
        <Image
